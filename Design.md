...
<figure>
  <img src="/img/Skizze_Lernmaterialien_02.svg" alt="Grafik Lernmaterialien" width="100%" />
...
- [Allgemeine, einleitende Informationen](#2)
...
Der Gestaltung von Lehrmaterialien legen Erkenntnisse aus dem Bereich Informationsdesign zugrunde. Dabei geht ein zeitgemäßer Gestaltungsbegriff weit über die allgemein verbreitete Annahme einer ästhetischen Verschönerung von Produkten vorwiegend aus der Konsumindustrie, kunstgewerblicher Praxis und und dekorativen Aspekten hinaus. Stattdessen steht die Konstruktion und Darstellung von Realität im Vordergrund, die interdisziplinäre Kenntnisse und Herangehensweisen beinhaltet, so dass bei einer Gestaltungslösung stets auch Disziplinen wie Ökologie, Ökonomie, Anthropologie, Soziologie, Psychologie, Physiologie und Anthropometrie mit berücksichtigt werden. Design ist eine Disziplin dazwischen in der Verbindung von Theorie und Praxis. Der Gestaltung von Lehrmaterialien legen Erkenntnisse aus dem Bereich Informationsdesign zugrunde. Dabei wird eine Zielgruppe, das Ausgabemedium, das technische Format (z.B. analog oder digital, Komprimierung, Dateiformat, aber auch Hoch- oder Querformat) die Möglichkeiten der Weiternutzung und Speicherung (z.B. Ausdruck, Archivierung, PDF, Folie) sowie die Vermittlungssituation (synchron, asynchron), eine bestimmte Gruppenstärke von Teilnehmerinnen und Teilnehmern, der Abstand zum Informationsmedium (beispielsweise das Lesen eines Skripts am Monitor oder ein gedrucktes Wissenschaftsposter in einem großen DIN Format oder ein Video-Podcast) berücksichtigt.

Grundsätzlich ist die reflexive Auseinandersetzung mit gestalterischen Details zu empfehlen (wie z.B. Schriftarten, Zeilenabständen, Laufweiten, Kraftlinien in Bildern aber auch Beschriftungen, Dateibezeichnungen oder Legenden in Diagrammen), die sich im Blick für Nuancen und Feinheiten niederschlägt. Hier gilt es, das eigene Sensorium für Verhältnisse, Kompositionen und vor allen Dingen gesamt systemische Zusammenhänge zu trainieren und in der Gestaltung von Lehrmitteln versiert einzusetzen.

Eine grundsätzliche Empfehlung ist der wohlbedachte, sparsame Einsatz von Darstellungselementen wie Anzahl von Schriften, Schriftschnitten- und größen, Filtern, Farben und Linienstärken etc. um eine visuelle Überfrachtung zu verhindern, die einen Wissenserwerb und die gedankliche Auseinandersetzung mit Informationen überfordern würde.

**Der Kontext bestimmt die Gestaltung**

Der versierte Einsatz von Texten, Bildern und Formen und die Komposition von grafischen Variablen in der Visualisierung von Informationen und Lehrmaterialien hängen von einer didaktischen Situation ab, die sich durch eine bestimmte Zielgruppe, einen Einsatzort, ein entsprechendes Medium und einem betreffenden Thema ergibt. Fragestellungen, die Hinweise für eine bestimmte Gestaltung geben können, wären zum Beispiel:

- Auf welche Jahrgangstufe oder Altersklasse bezieht sich das Lehrmaterial?
- Dienen die Vorlagen Studierenden als ausführliches Skript oder unterstützen die Folien nur  stichwortartig eine Präsentation oder einen Vortrag?
- Werden Bilder, Texte und Inhalte als zentrales Material für eine Prüfungsvorbereitung eingesetzt oder bieten sie einer Präsentation eine Art Fahrplan, Überblick oder wird eine übergeordnete Struktur aufgezeigt?

Materialien, die für eine Prüfungsvorbereitung eingesetzt werden, sollten ausführlichere und detailliertere Informationen darstellen. Andererseits können großzügig gestaltete Lehrmaterialien mit viel Weißraum und Lückentexten, Checkboxen und Platz zur Beantwortung von Fragen den Studierenden zur Verfügungen gestellt werden, um zum Beispiel eigene Notizen festzuhalten oder auch aktiver über Fragestellungen nachzudenken, selbst Zusammenhänge herzustellen und in der Vor- und oder Nachbereitung Lösungen einzutragen oder ein bestimmtes Thema genauer zu reflektieren.

Für einen ersten Einstieg ist dieser freie, spielerische Online-Kurs zu empfehlen: [https://grafikgrundlagen.com](https://grafikgrundlagen.com).

In den folgenden Kapiteln wurde ein erstes grundlegendes Verständnis und Empfehlungen für die Gestaltung von Lehrmaterialien zusammengestellt. Im Kapitel gestaltprinzipien werden maßgeblich bestimmende Gesetzmäßigkeiten und Erfahrungswerte aufgeführt. Es werden Kompositionen und Verhältnisse von verschiedenen Darstellungelementen aufgezeigt, an denen man sich bei der Gestaltung von Lehrmaterialien orientieren kann. Im weiteren Verlauf für dann spezifisch auf die Bereiche Text, Typographie und Visualisierung in der Form von Bildern, Diagrammen, Charts und Karten eingegangen.

## Gestaltungsprinzipien und didaktisches Design

Lehrmaterialien, Skripte und sichtbare Informationen machen einen stummen Dialog sichtbar. Eine sparsame Typografie, eine reduzierte Grafik und eine funktionsbestimmte Form unterstützen die Vermittlung von Klarheit, Ordnung und Gewissheit wissenschaftlicher Informationen. Didaktisches Design ist nach Ballstaedt die „planmäßige und lernwirksame Entwicklung von Lernumgebungen (…) auf wissenschaftlicher Grundlage“ (1997, S.12).
...
Aus den Erkenntnisse der Gestaltpsychologie können die Gestaltgesetze abgeleitet werden. Diese Empfehlungen und Regeln für die visuelle Darstellung von Informationen wie Daten, Zahlen, Texte und Bildern fördern eine raschere und zugängliche Orientierung, da sie bestimmte kognitive Mechanismen und Erklärungsmuster unterstützen.Die Kenntnis und Anwendung dieser Regeln ist bei der Erstellung von Lehr- und Lernmaterialien dienlich, so kann verhindert werden, dass Lehrmaterial visuell überfrachtet,  leseunfreundlich und beschwerlich wahrgenommen wird.
...
**Gesetz der Ähnlichkeit/ Prinzip der Konsistenz**
...
Schnell werden Grafiken, Symbole, Bilder und Ornamente aber auch Animationen, Übergänge und besondere Merkmale wie Drehungen, Einblendungen und Farbverläufe in der Gestaltung von Lehrmaterialien eingesetzt, da diese in Bilddatenbanken, Vorlagen und Makros einfach handhabbar zur Verfügung gestellt werden. Grafische Mittel und visuelle Marker sollten jedoch nur mit Sinn und Bedacht eingesetzt werden, eben um einen Lern- und Erkenntnisprozess zu fördern. Willkürliche Schmuckelemente können von wesentlichen Inhalten und Aussagen ablenken und tragen bei komplexen Themen eher zu Desorientierung statt zu Transparenz und Anschaulichkeit bei. In der Wissensvermittlung kommt hier die didaktische Reduktion zum Tragen wobei Lerninhalte so strukturiert und angeordnet werden, dass sie verständlich fassbar und nachvollziehbar sind.
...
Grafische Variablen sind zum Beispiel Punkte, Linien, Flächen und typografische Zeichen, die in unterschiedlichen Kompositionen angeordnet werden können. In der Anordnung der grafischen Variablen können bestimmte Zusammenhänge und Hierarchien visualisiert werden und so entsprechende Bedeutungen und Eigenschaften vermittelt werden. Dabei werden Zusammengehörigkeit, Rangfolgen und Wichtigkeiten dargestellt. Die zuvor aufgeführten Gestaltprinzipien werden in folgenden Darstellungen wieder sichtbar.
...
<figure>
  <img src="/img/darstellungselemente/grafischeVariablen/position.svg" alt="Abbildung ??: Position" width="80%" />
  <figcaption> Abb. ??: Position </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/grafischeVariablen/farbtonUndMuster.svg" alt="Abbildung ??: Farbton und Muster" width="80%" />
  <figcaption> Abb. ??: Farbton und Muster </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/grafischeVariablen/groesse.svg" alt="Abbildung ??: Größe" width="80%" />
  <figcaption> Abb. ??: Größe </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/grafischeVariablen/richtung.svg" alt="Abbildung ??: Richtung" width="80%" />
  <figcaption> Abb. ??: Richtung </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/grafischeVariablen/helligkeitUndSaettigung.svg" alt="Abbildung ??: Helligkeit und Sättigung" width="80%" />
  <figcaption> Abb. ??: Helligkeit und Sättigung </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/grafischeVariablen/form.svg" alt="Abbildung ??: Form" width="80%" />
  <figcaption> Abb. ??: Form </figcaption>
</figure>

<br>
<br>

**Grafische Elemente wie Linien, Kästen, Rahmen, Symbole, Umrandungen**
...
Waagerechte und senkrechte Linien Linien können eine visuelle Hierarchie schaffen
...
<figure>
  <img src="/img/darstellungselemente/grafischeVariablen/dini_poster.jpg" alt="Abbildung ??: DINI Poster" width="80%" />
  <figcaption> Abb. ??: DINI Poster </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/text/serife.svg" alt="Abbildung ??: Serife" width="80%" />
  <figcaption> Abb. ??: Serife </figcaption>
</figure>

Bei _Serifen_ handelt es sich um An- und Abstriche, d.h. Anfangs- und Endstriche von Buchstaben. Serifen sind kurze Linienelemente, die Formen von Buchstaben und Zeichen orthogonal abschliessen.
...
<figure>
  <img src="/img/darstellungselemente/text/antiqua.svg" alt="Abbildung ??: Antiqua" width="80%" />
  <figcaption> Abb. ??: Antiqua </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/text/modern.svg" alt="Abbildung ??: Modern" width="80%" />
  <figcaption> Abb. ??: Modern </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/text/grotesk.svg" alt="Abbildung ??: Grotesk" width="80%" />
  <figcaption> Abb. ??: Grotesk </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/text/schriftfamilie.svg" alt="Abbildung ??: Schriftfamilien" width="80%" />
  <figcaption> Abb. ??: Schriftfamilien </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/text/editor.svg" alt="Abbildung ??: Interface Schrifteinstellungen" width="80%" />
  <figcaption> Abb. ??: Interface Schrifteinstellungen </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/text/schriftkombinationen.svg" alt="Abbildung ??: Schriftkombinationen" width="80%" />
  <figcaption> Abb. ??: Schriftkombinationen </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/text/laufweite.svg" alt="Abbildung ??: Laufweite" width="80%" />
  <figcaption> Abb. ??: Laufweite </figcaption>
</figure>
...
<figure>
  <img src="/img/darstellungselemente/text/satzart.svg" alt="Abbildung ??: Satzarten" width="80%" />
  <figcaption> Abb. ??: Satzarten </figcaption>
</figure>

Man unterscheidet Blocksatz, Mittelachse, linksbündiger Flattersatz und rechtsbündiger Flattersatz. Längere Texte (wie z.B. eine wissenschaftliche Abhandlung), die einen ruhigen Lesefluss haben, werden oft in Blocksatz gesetzt. Ein linksbündiger Flattersatz wird häufig für kürzere Texte oder Texte, die in schmalen Spalten unter 50 Anschlägen pro Zeile gesetzt werden, eingesetzt. Ein rechtsbündiger Flattersatz bzw. Lange Texte in Mittelachse wirken ermüdend für das Auge, da die Zeilenanfänge am linken Textrand nur schwer gefunden werden. Grundsätzlich wird empfohlen, einen linksbündigen Flattersatz einzusetzen. Für das Layout eines lesefreundlichen Blocksatzes sind aufwendige, mikrotypografische Einstellungen notwendig, die sich in den gängigen Layoutprogrammen nicht intuitiv einstellen lassen.
...
Das informierende Lesen, wie die Lektüre von Zeitungsbeiträgen, Fachliteratur, Handreichungen oder Leitfäden bietet mit kürzeren Zeilen, Zwischenüberschriften und Auszeichnungen einen schnellen Überblick. Das rasche Erfassen eines Inhalts ist in der Form des sogenannten _Querlesens_ möglich.
